...
<div className='container mx-auto md:mb-10 flex justify-center md:mt-[60px]'>
  ...
  <div className="mx-auto max-w-[100%] text-center">
    <h2 className="font-semibold text-center md:text-[20px] text-[16px] leading-[44px] md:leading-[52px] md:text-heading-3 md:mt-[70px] md:mb-[50px] lg:mb-[10px]">SAP Services</h2>
    <span className="underline decoration-[#75EAE2] text-[#75EAE2] decoration-[3px]">__________</span>
    <p className="text-body-color text-xs">
