                    ...
                    <div className='bg-white hover:scale-105 ease-in duration-300'>
                        ...
                        <div className='grid md:grid-cols-3 grid-cols-1 gap-2 px-1'>
                            ...
                            {DigitalServices && DigitalServices.map((listTwo, index) => (
                                <div key={index} className="md:w-[175px] md:py-1 hover:border-[#75EAE2] border-2 bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                    <div className="p-1">
                                        {listTwo.imageUrl &&
                    ...
                    <div className='hover:scale-105 ease-in duration-300'>
                        ...
                        <div className='grid md:grid-cols-3 grid-cols-1 gap-2 px-1'>
                            ...
                            {StreamlinedDevelopment && StreamlinedDevelopment.map((listThree, index) => (
                                <div key={index} className="md:w-[175px] md:py-1 bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden hover:border-[#75EAE2] border-2">
                                    <div className="p-2">
                                        {listThree.imageUrl &&
                                            <div className='flex justify-center'>
