...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className='flex justify-between items-center flex-wrap max-w-screen-xl mx-auto w-full h-full px-2 2xl:px-16 font-bold '>
        <Link href='/'>
          <Image
            src={NavLogo}
            alt='/'
...

            {
              MenuList?.map((menu, i) => (
                <div key={menu.name} className='md:mb-1'>
                  ...
                  <li className='font:bold w-1/3 border border-[#75EAE2] border-b-2 border-l-0 border-r-0 border-t-0 flex mx-5 text-[15px]'>
